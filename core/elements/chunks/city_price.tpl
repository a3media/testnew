<div id="city_price" class="city_price">
  <div class="container">
    {if $_modx->context.key == 'web'}
      ...
      {/if}
    {else}
      <h2 class="text-center">Стоимость грузоперевозки {$_modx->config.city} - {$_modx->resource.pagetitle} - {$_modx->config.city}</h2>
    {/if}
    <div class="row justify-content-center">
      <div class="col-md-10">
      {$_modx->runSnippet('price2', [
          'km1' => $_modx->resource.km1,
          'km2' => $_modx->resource.km2,
          'km1_ob' => $_modx->resource.km1_ob,
          'km2_ob' => $_modx->resource.km2_ob,
