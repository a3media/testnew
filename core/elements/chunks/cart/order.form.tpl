{set $form.email = 'info@mail.ru'}
{set $form.receiver = 'Иванов Иван Иванович'}
{set $form.phone = '+790090003030'}
{set $form.comment = 'Комментарий к заказу'}
{set $form.index = '654000'}
{set $form.region = 'Новосибирская область'}
{set $form.city = 'Новосибирск'}
{set $form.street = 'Кирова'}
{set $form.street = 'Кирова'}
{set $form.building = '108'}
{set $form.room = '22'}
