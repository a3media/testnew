...
<form class="form well ec-form" method="post" role="form" id="ec-form-{$fid}" data-fid="{$fid}" action="" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="ec-user_contacts-{$fid}" class="control-label">Телефон</label>
        <input type="text" name="user_contacts" class="form-control phone_input" id="ec-user_contacts-{$fid}" value="{$user_contacts}" />
    ...
    <div class="form-group d-none">
        ...
        <input type="text" name="subject" class="form-control" id="ec-subject-{$fid}" value="Квартирный переезд" />
    ...
    <div class="form-group">
        ...
        <div class="ec-rating ec-clearfix" data-storage-id="ec-rating-{$fid}">
            ...
            <div class="ec-rating-description small">{'ec_fe_message_rating_0' | lexicon}</div>
        </div>
    ...
    <div class="form-group">
        ...
        <textarea type="text" name="text" class="form-control mb-3" rows="5" id="ec-text-{$fid}">{$text}</textarea>
