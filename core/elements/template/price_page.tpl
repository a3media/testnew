...
<div class="container">
        ...
        <h2>Стоимость грузоперевозок по России</h2>
...
{include 'file:chunks/home/home_countries.tpl'}
  ...
  <h2 class="text-center text-white font-weight-bold">Населенного пункта нет в списке?</h2>
    <div class="row justify-content-center text-center">
      ...
      <div class="col-lg-5">
          ...
          <button type="button" name="button" class="btn btn-primary"  data-toggle="modal" data-target="#modal_request" data-whatever="населенного пункта нет">Заполнить заявку</button>
      </div>
      <div class="col-lg-2">
